...
from src.calibre_books.core.book import Book, BookMetadata, LibraryStats
...
class TestCalibreDB:
    ...
    def test_list_books(self):
        ...
        with patch.object(Path, 'exists', return_value=True), \
            ...
            assert result.success
            mock_exec.assert_called_once_with(['list', '--fields', 'id,title', '--for-machine'])
